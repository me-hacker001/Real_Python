...
class Game:
	def __init__(self):
		...
		self.bg = PhotoImage(file="Games_Code/Stick-Man-Game/resources/background.png")
		w = self.bg.width()
		h = self.bg.height()
		for x in range(0, 5):
			for y in range(0, 5):
...
class DoorSprite(Sprite):
	def __init__(self, g, x, y, width, height):#hei1353
		Sprite.__init__(self, g)
		self.closed_door = PhotoImage(file="Games_Code/Stick-Man-Game/resources/door1.gif")
		self.open_door = PhotoImage(file="Games_Code/Stick-Man-Game/resources/door2.gif")
...
class StickFigureSprite(Sprite):
	def __init__(self, g):
		Sprite.__init__(self, g)
		self.images_left = [
			PhotoImage(file="Games_Code/Stick-Man-Game/resources/figure-L1.gif"),
			PhotoImage(file="Games_Code/Stick-Man-Game/resources/figure-L2.gif"),
			PhotoImage(file="Games_Code/Stick-Man-Game/resources/figure-L3.gif")
		]
		self.images_right = [
			PhotoImage(file="Games_Code/Stick-Man-Game/resources/figure-R1.gif"),
			PhotoImage(file="Games_Code/Stick-Man-Game/resources/figure-R2.gif"),
			PhotoImage(file="Games_Code/Stick-Man-Game/resources/figure-R3.gif")
		]
...
games = Game()
form1 = PlatformSprite(games, PhotoImage(file = "Games_Code/Stick-Man-Game/resources/platform1.gif"), 0, 480, 100, 10)
form2 = PlatformSprite(games, PhotoImage(file = "Games_Code/Stick-Man-Game/resources/platform1.gif"), 150, 440, 100, 10)
form3 = PlatformSprite(games, PhotoImage(file = "Games_Code/Stick-Man-Game/resources/platform1.gif"), 300, 400, 100, 10)
form4 = PlatformSprite(games, PhotoImage(file = "Games_Code/Stick-Man-Game/resources/platform1.gif"), 300, 160, 100, 10)
form5 = PlatformSprite(games, PhotoImage(file = "Games_Code/Stick-Man-Game/resources/platform2.gif"), 175, 350, 66, 10)
form6 = PlatformSprite(games, PhotoImage(file = "Games_Code/Stick-Man-Game/resources/platform2.gif"), 50, 300, 66, 10)
form7 = PlatformSprite(games, PhotoImage(file = "Games_Code/Stick-Man-Game/resources/platform2.gif"), 170, 120, 66, 10)
form8 = PlatformSprite(games, PhotoImage(file = "Games_Code/Stick-Man-Game/resources/platform2.gif"), 45, 60, 66, 10)
form9 = PlatformSprite(games, PhotoImage(file = "Games_Code/Stick-Man-Game/resources/platform3.gif"), 170, 250, 32, 10)
form10 = PlatformSprite(games, PhotoImage(file = "Games_Code/Stick-Man-Game/resources/platform3.gif"), 230, 200, 32, 10)
