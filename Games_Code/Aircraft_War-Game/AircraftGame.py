...
# Loading game music
BULLETSHOT_SOUNDTEST = pygame.mixer.Sound('Games_Code/Aircraft_War-Game/image/sound/bullet.wav')
OPPONENT1_DOWN_SOUNDTEST = pygame.mixer.Sound('Games_Code/Aircraft_War-Game/image/sound/opponent1_down.wav')
GAMEOVER_SOUNDTEST = pygame.mixer.Sound('Games_Code/Aircraft_War-Game/image/sound/game_over.wav')
BULLETSHOT_SOUNDTEST.set_volume(0.3)
OPPONENT1_DOWN_SOUNDTEST.set_volume(0.3)
GAMEOVER_SOUNDTEST.set_volume(0.3)
pygame.mixer.music.load('Games_Code/Aircraft_War-Game/image/sound/game_music.wav')
pygame.mixer.music.play(-1, 0.0)
pygame.mixer.music.set_volume(0.25)

# loading background image
GAME_BACKGROUND = pygame.image.load('Games_Code/Aircraft_War-Game/image/image/background.png').convert()
GAME_OVER = pygame.image.load('Games_Code/Aircraft_War-Game/image/image/gameover.png')
filename = 'Games_Code/Aircraft_War-Game/image/image/aircraft_shooter.png'
