...
jump_sound = pygame.mixer.Sound('Games_Code/Dino-Game/resources/jump.wav')
die_sound = pygame.mixer.Sound('Games_Code/Dino-Game/resources/die.wav')
checkPoint_sound = pygame.mixer.Sound('Games_Code/Dino-Game/resources/checkPoint.wav')
...
def load_image(
    ...
    fullname = os.path.join('Games_Code/Dino-Game/resources', name)
...
def load_sprite_sheet(
    ...
    fullname = os.path.join('Games_Code/Dino-Game/resources', s_name)
