...
car_photo = pygame.image.load(os.getcwd() + '//Games_Code/F1-Road-Race-Game/images/car.png')
left_c = pygame.image.load(os.getcwd() + '//Games_Code/F1-Road-Race-Game/images/car_left.png')
right_c = pygame.image.load(os.getcwd() + '//Games_Code/F1-Road-Race-Game/images/car_right.png')
photo_obstacle = pygame.image.load(os.getcwd() + '//Games_Code/F1-Road-Race-Game/images/obstacle.png')
texture_photo = pygame.image.load(os.getcwd() + '//Games_Code/F1-Road-Race-Game/images/texture.png')
...
icon = pygame.image.load(os.getcwd() + '//Games_Code/F1-Road-Race-Game/images/logo.png')
pygame.display.set_icon(icon)

image_background = pygame.image.load(os.getcwd() + '//Games_Code/F1-Road-Race-Game/images/background.png')
image_background_still = pygame.image.load(os.getcwd() + '//Games_Code/F1-Road-Race-Game/images/background_inv.png')
bckgrndRect = image_background.get_rect()

welcome_1 = pygame.mixer.Sound(os.getcwd() + '//Games_Code/F1-Road-Race-Game/audio/intro1.wav')
welcome_2 = pygame.mixer.Sound(os.getcwd() + '//Games_Code/F1-Road-Race-Game/audio/intro2.wav')
audio_crash = pygame.mixer.Sound(os.getcwd() + '//Games_Code/F1-Road-Race-Game/audio/car_crash.wav')
audio_ignition = pygame.mixer.Sound(os.getcwd() + '//Games_Code/F1-Road-Race-Game/audio/ignition.wav')
pygame.mixer.music.load(os.getcwd()+'//Games_Code/F1-Road-Race-Game/audio/running.wav')
...
def looping_gameplay():
	...
	highest_score_txtfile = open(os.getcwd()+'/Games_Code/F1-Road-Race-Game/textfile/high_score.txt','r')
